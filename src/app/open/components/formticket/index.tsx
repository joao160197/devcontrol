...
export function FormTicket({ customer }: formTicketsProps) {
  const {
    register,
    handleSubmit,
    setValue,
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="bg-blue-500 rounded-md w-full h-11 px-2 text-white font-bold hover:bg-blue-600 duration-100"
      >
        Cadastrar
      </button>
    </form>
